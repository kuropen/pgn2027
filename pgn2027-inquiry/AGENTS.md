...
<custom-instruction-in-this-project>

=== Custom Instruction in pgn2027-inquiry Project ===

# Handling README files
- Information for the developer should be written in README.local.md in Japanese.
- README.md is published for technology disclosure, so overview of the project in English should be in this file. **DO NOT WRITE ANY SENSITIVE INFORMATION HERE.**
